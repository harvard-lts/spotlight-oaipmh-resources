...
include OAI::XPath
  ...
  RSpec.describe Spotlight::OaipmhHarvester, type: :model do
    let(:exhibit) { FactoryGirl.create(:exhibit) }
    subject { described_class.create(exhibit_id: exhibit.id, base_url: 'http://api-qa.lib.harvard.edu:8080/oai', set: 'CNA') }
